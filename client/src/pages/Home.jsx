...
      setFriends((prev) => {
        const index = prev.findIndex((f) => f._id === friendId);
        if (index === -1) return prev;


        const updated = [...prev];
        const [friend] = updated.splice(index, 1);
...
                            </div>
                            <div>
                              <h6 className="mb-1 fw-semibold">{f.username || f.email}</h6>
                              <p className="text-muted mb-0 small">{lastMessages[f._id]?.text || f.email}</p>
                            </div>
                          </div>
